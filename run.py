...
if not args.disable_optimizations and not args.dense and args.stride == 1:
    ...
    # When incompatible settings are detected (stride > 1, dense filters, or disabled optimization) fall back to
    # normal model
    ...
    while epoch < args.epochs:
        ...
        if semi_supervised:
            ...
            for _, batch_3d, batch_2d in train_generator.next_epoch():
                ...
                if step % 100 == 0:
                    with open('train-log-sh.log', 'a+') as f:
                        print("Epoch {}/{} step {} loss:{:.6f}".format(epoch + 1, args.epochs, step, loss_total.item()),
                              file=f)
                step += 1
